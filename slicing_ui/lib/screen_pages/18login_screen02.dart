...
import 'package:slicing_ui/screen_pages/19login_screen03.dart';


class LoginScreen02 extends StatelessWidget {
  const LoginScreen02({Key? key}) : super(key: key);
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 0.0, vertical: 0.0), // Sesuaikan padding horizontal di sini
                            child: Padding(
                              padding: EdgeInsets.only(right: 140), // Tetapkan jarak dari kanan
                              child: Text(
                                'Enter your email for the verification process, we will send a 4-digit code to your email.', // Ganti dengan teks Anda yang lain
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 12,
                                ),
                    ...
                    Center(
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => LoginScreen03()),
                          );
